...
#load the pretrained MMOD model
face_detection_classifier = dlib.cnn_face_detection_model_v1('C:/Users/ASUS/OneDrive/Desktop/Face Recognition Project/code/models/mmod_human_face_detector.dat')
