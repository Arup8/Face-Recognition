...
image_to_detect = cv2.imread('C:/Users/ASUS/OneDrive/Desktop/Face Recognition Project/code/images/samples/E.jpg')
...
# # By using shape_predictor_68_face_landmarks
# import cv2
# import dlib

# # loading the image to detect
# image_to_detect = cv2.imread('C:/Users/ASUS/OneDrive/Desktop/Face Recognition Project/code/images/samples/modi.jpg')
...
# # object to hold the face landmark points for every face
# # each object will contain the box points and list of facial points.
# face_landmarks = []
...
# # looping through the face locations
# for index, current_face_location in enumerate(all_face_locations):
#     # predict face landmarks using the 68 landmarks model
#     landmarks = face_shape_predictor(image_to_detect, current_face_location)
#     face_landmarks.append(landmarks)

# # loop through the face landmarks and show them
...
#         cv2.circle(image_to_detect, point, 2, (0, 255, 0), -1)

# # show the image with landmarks
# cv2.imshow("Image with Landmarks", image_to_detect)
