...
from keras.utils import conv_utils as layer_utils
...
sample_faces = [detect_extract_face('code/dataset/training/modi/1.jpg'),
                detect_extract_face('code/dataset/training/modi/2.jpg'),
                detect_extract_face('code/dataset/training/modi/3.jpg'),
                detect_extract_face('code/dataset/training/biden/1.jpg')]        
