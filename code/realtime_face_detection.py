...
while True:
    ...
    for i, curr_face in enumerate(all_face):
        ...
        # 11. Draw rectangle around each face location in the main video frame inside the loop 
    ...
    #12. Displaying the current frame outside for loop inside the while loop
