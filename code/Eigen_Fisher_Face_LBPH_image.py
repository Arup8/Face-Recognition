...
def face_detection(image_to_detect):
    ...
    face_detection_classifier = cv2.CascadeClassifier('C:/Users/ASUS/OneDrive/Desktop/Face Recognition Project/code/models/haarcascade_frontalface_default.xml')
...
names.append("Arup")
face_coordinates_arup, labels_index_arup = prepare_training_data("C:/Users/ASUS/OneDrive/Desktop/Face Recognition Project/code/dataset/training/arup",0)

names.append("Narendra Modi")
face_coordinates_modi, labels_index_modi = prepare_training_data("C:/Users/ASUS/OneDrive/Desktop/Face Recognition Project/code/dataset/training/modi",1)
    
names.append("Joe Biden")
face_coordinates_biden, labels_index_biden = prepare_training_data("C:/Users/ASUS/OneDrive/Desktop/Face Recognition Project/code/dataset/training/biden",2)
    
names.append("Robert Downey Jr.")
face_coordinates_rdj, labels_index_rdj = prepare_training_data("C:/Users/ASUS/OneDrive/Desktop/Face Recognition Project/code/dataset/training/rdj",3)
face_coordinates = face_coordinates_arup + face_coordinates_modi + face_coordinates_biden + face_coordinates_rdj
labels_index = labels_index_arup + labels_index_modi + labels_index_biden + labels_index_rdj
...
######## prediction ##############
# image_to_classify = cv2.imread("C:/Users/ASUS/OneDrive/Desktop/Face Recognition Project/code/dataset/testing/joe1.jpg")
image_to_classify = cv2.imread("code/dataset/testing/RDJ4.jpg")
